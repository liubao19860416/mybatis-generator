...
public class MybatisServicePlugin extends PluginAdapter {
	...
	private boolean enableDeleteByParams = false;
	private boolean enableUpdateByParams = false;
	private boolean enableUpdateByParamsSelective = false;
	...
	public boolean validate(List<String> warnings) {
		...
		String enableUpdateByParamsSelective = properties.getProperty("enableUpdateByParamsSelective");
		...
		String enableDeleteByParams = properties.getProperty("enableDeleteByParams");

		String enableUpdateByPrimaryKeySelective = properties.getProperty("enableUpdateByPrimaryKeySelective");

		String enableUpdateByParams = properties.getProperty("enableUpdateByParams");

		if (StringUtility.stringHasValue(enableInsert))
			this.enableInsert = StringUtility.isTrue(enableInsert);
		if (StringUtility.stringHasValue(enableUpdateByParamsSelective))
			this.enableUpdateByParamsSelective = StringUtility.isTrue(enableUpdateByParamsSelective);
		...
		if (StringUtility.stringHasValue(enableDeleteByParams))
			this.enableDeleteByParams = StringUtility.isTrue(enableDeleteByParams);
		...
		if (StringUtility.stringHasValue(enableUpdateByParams))
			this.enableUpdateByParams = StringUtility.isTrue(enableUpdateByParams);
	...
	protected void addService(Interface interface1,IntrospectedTable introspectedTable, String tableName, List<GeneratedJavaFile> files) {
		...
		// 添加方法
		Method method = countByParams(introspectedTable, tableName);
		...
		method = selectByParams(introspectedTable, tableName);
		method.removeAllBodyLines();
		interface1.addMethod(method);
		...
		if (enableDeleteByParams) {
			method = getOtherInteger("deleteByParams", introspectedTable, tableName, 3);
			method.removeAllBodyLines();
			interface1.addMethod(method);
		}
		if (enableUpdateByParamsSelective) {
			method = getOtherInteger("updateByParamsSelective", introspectedTable, tableName, 4);
			method.removeAllBodyLines();
			interface1.addMethod(method);
		}
		if (enableUpdateByParams) {
			method = getOtherInteger("updateByParams", introspectedTable, tableName, 4);
			method.removeAllBodyLines();
			interface1.addMethod(method);
		}
		if (enableInsert) {
	...
	protected void addServiceImpl(TopLevelClass topLevelClass,IntrospectedTable introspectedTable, String tableName, List<GeneratedJavaFile> files) {
		...
		// 添加方法
		topLevelClass.addMethod(countByParams(introspectedTable, tableName));
		topLevelClass.addMethod(selectByPrimaryKey(introspectedTable, tableName));
		topLevelClass.addMethod(selectByParams(introspectedTable, tableName));
		...
		if (enableDeleteByParams) {
			topLevelClass.addMethod(getOtherInteger("deleteByParams", introspectedTable, tableName, 3));
		}
		if (enableUpdateByParamsSelective) {
			topLevelClass.addMethod(getOtherInteger("updateByParamsSelective", introspectedTable, tableName, 4));
		}
		if (enableUpdateByParams) {
			topLevelClass.addMethod(getOtherInteger("updateByParams", introspectedTable, tableName, 4));
		}
		if (enableInsert) {
	 ...
	 * 
	 */
	protected Method countByParams(IntrospectedTable introspectedTable, String tableName) {
		Method method = new Method();
		method.setName("countByParams");
	 ...
	 * 
	 */
	protected Method selectByParams(IntrospectedTable introspectedTable, String tableName) {
		Method method = new Method();
		method.setName("selectByParams");
		...
		if (introspectedTable.hasBLOBColumns()) {
			sb.append("selectByParamsWithoutBLOBs");
		} else {
			sb.append("selectByParams");
		}
		sb.append("(");
		sb.append("example");
		sb.append(");");
	...
	protected Method getOtherInteger(String methodName, IntrospectedTable introspectedTable, String tableName, int type) {
		...
		if (introspectedTable.hasBLOBColumns()
				&& (!"updateByPrimaryKeySelective".equals(methodName) && !"deleteByPrimaryKey".equals(methodName)
						&& !"deleteByParams".equals(methodName) && !"updateByParamsSelective".equals(methodName))) {
	...
	protected String addParams(IntrospectedTable introspectedTable, Method method, int type1) {
		...
		case 4:
			...
			if(method.getName().equals("updateByParamsSelective")||method.getName().equals("updateByParams")){
