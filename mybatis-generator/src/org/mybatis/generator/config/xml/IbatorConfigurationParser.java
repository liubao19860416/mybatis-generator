...
public class IbatorConfigurationParser {
	...
	private void parseTable(Context context, Node node) {
		...
		String enableSelectByParams = attributes.getProperty("enableSelectByParams"); //$NON-NLS-1$
		...
		String enableDeleteByParams = attributes.getProperty("enableDeleteByParams"); //$NON-NLS-1$
		String enableCountByParams = attributes.getProperty("enableCountByParams"); //$NON-NLS-1$
		String enableUpdateByParams = attributes.getProperty("enableUpdateByParams"); //$NON-NLS-1$
		String selectByPrimaryKeyQueryId = attributes.getProperty("selectByPrimaryKeyQueryId"); //$NON-NLS-1$
		String selectByParamsQueryId = attributes.getProperty("selectByParamsQueryId"); //$NON-NLS-1$
		...
		if (stringHasValue(enableSelectByParams)) {
			tc.setSelectByParamsStatementEnabled(isTrue(enableSelectByParams));
		}
		...
		if (stringHasValue(enableDeleteByParams)) {
			tc.setDeleteByParamsStatementEnabled(isTrue(enableDeleteByParams));
		}

		if (stringHasValue(enableCountByParams)) {
			tc.setCountByParamsStatementEnabled(isTrue(enableCountByParams));
		}

		if (stringHasValue(enableUpdateByParams)) {
			tc.setUpdateByParamsStatementEnabled(isTrue(enableUpdateByParams));
		}
		...
		if (stringHasValue(selectByParamsQueryId)) {
			tc.setSelectByParamsQueryId(selectByParamsQueryId);
		}
