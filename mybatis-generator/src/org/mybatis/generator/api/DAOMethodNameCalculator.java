...
public interface DAOMethodNameCalculator {
	 ...
	 * @return the calculated name
	 */
	String getSelectByParamsWithoutBLOBsMethodName(IntrospectedTable introspectedTable);
	 ...
	 * @return the calculated name
	 */
	String getSelectByParamsWithBLOBsMethodName(IntrospectedTable introspectedTable);
	 ...
	 * @return the calculated name
	 */
	String getDeleteByParamsMethodName(IntrospectedTable introspectedTable);
	 ...
	 * @return the calculated name
	 */
	String getCountByParamsMethodName(IntrospectedTable introspectedTable);
	 ...
	 * @return the calculated name
	 */
	String getUpdateByParamsSelectiveMethodName(IntrospectedTable introspectedTable);
	 ...
	 * @return the calculated name
	 */
	String getUpdateByParamsWithBLOBsMethodName(IntrospectedTable introspectedTable);
	 ...
	 * @return the calculated name
	 */
	String getUpdateByParamsWithoutBLOBsMethodName(IntrospectedTable introspectedTable);
}
