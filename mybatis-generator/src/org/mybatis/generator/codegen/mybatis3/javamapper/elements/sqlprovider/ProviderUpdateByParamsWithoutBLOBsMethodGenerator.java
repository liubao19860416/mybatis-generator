 ...
 * 
 */
public class ProviderUpdateByParamsWithoutBLOBsMethodGenerator extends AbstractJavaProviderMethodGenerator {

	public ProviderUpdateByParamsWithoutBLOBsMethodGenerator() {
		super();
	}
	...
	public String getMethodName() {
		return introspectedTable.getUpdateByParamsStatementId();
	}
	...
	public boolean callPlugins(Method method, TopLevelClass topLevelClass) {
		return context.getPlugins().providerUpdateByParamsWithoutBLOBsMethodGenerated(method, topLevelClass,
				introspectedTable);
	}
}
