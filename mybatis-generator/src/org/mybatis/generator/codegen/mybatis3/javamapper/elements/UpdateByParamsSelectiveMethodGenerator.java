 ...
 * 
 */
public class UpdateByParamsSelectiveMethodGenerator extends AbstractJavaMapperMethodGenerator {
	...
	public void addInterfaceElements(Interface interfaze) {
		...
		method.setName(introspectedTable.getUpdateByParamsSelectiveStatementId());
		...
		if (context.getPlugins().clientUpdateByParamsSelectiveMethodGenerated(method, interfaze, introspectedTable)) {
