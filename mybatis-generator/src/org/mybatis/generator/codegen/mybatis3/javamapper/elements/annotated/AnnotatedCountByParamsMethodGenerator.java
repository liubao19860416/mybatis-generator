 ...
 * @author Jeff Butler
 */
public class AnnotatedCountByParamsMethodGenerator extends CountByParamsMethodGenerator {

	public AnnotatedCountByParamsMethodGenerator() {
		super();
	}
	...
	public void addMapperAnnotations(Interface interfaze, Method method) {
		...
		sb.append(introspectedTable.getCountByParamsStatementId());
		sb.append("\")"); //$NON-NLS-1$
