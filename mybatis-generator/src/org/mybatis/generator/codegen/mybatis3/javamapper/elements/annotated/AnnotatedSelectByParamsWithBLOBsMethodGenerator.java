 ...
 * @author Jeff Butler
 */
public class AnnotatedSelectByParamsWithBLOBsMethodGenerator extends SelectByParamsWithBLOBsMethodGenerator {

	public AnnotatedSelectByParamsWithBLOBsMethodGenerator() {
		super();
	}
	...
	public void addMapperAnnotations(Interface interfaze, Method method) {
		...
		sb.append(introspectedTable.getSelectByParamsWithBLOBsStatementId());
		sb.append("\")"); //$NON-NLS-1$
