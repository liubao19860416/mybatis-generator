 ...
 * @author Jeff Butler
 */
public class AnnotatedUpdateByParamsWithBLOBsMethodGenerator extends UpdateByParamsWithBLOBsMethodGenerator {

	public AnnotatedUpdateByParamsWithBLOBsMethodGenerator() {
		super();
	}
	...
	public void addMapperAnnotations(Interface interfaze, Method method) {
		...
		sb.append(introspectedTable.getUpdateByParamsWithBLOBsStatementId());
		sb.append("\")"); //$NON-NLS-1$
