 ...
 * 
 */
public class UpdateByParamsWithoutBLOBsMethodGenerator extends AbstractJavaMapperMethodGenerator {
	...
	public void addInterfaceElements(Interface interfaze) {
		...
		method.setName(introspectedTable.getUpdateByParamsStatementId());
		...
		if (context.getPlugins().clientUpdateByParamsWithoutBLOBsMethodGenerated(method, interfaze, introspectedTable)) {
