 ...
 * 
 */
public class ProviderUpdateByParamsSelectiveMethodGenerator extends AbstractJavaProviderMethodGenerator {
	...
	public void addClassElements(TopLevelClass topLevelClass) {
		...
		Method method = new Method(introspectedTable.getUpdateByParamsSelectiveStatementId());
		...
		if (context.getPlugins().providerUpdateByParamsSelectiveMethodGenerated(method, topLevelClass,
				introspectedTable)) {
