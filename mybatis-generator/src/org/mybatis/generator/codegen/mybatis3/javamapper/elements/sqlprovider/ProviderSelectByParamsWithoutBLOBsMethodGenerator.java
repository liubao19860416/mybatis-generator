 ...
 * 
 */
public class ProviderSelectByParamsWithoutBLOBsMethodGenerator extends AbstractJavaProviderMethodGenerator {

	public ProviderSelectByParamsWithoutBLOBsMethodGenerator() {
		super();
	}
	...
	public String getMethodName() {
		return introspectedTable.getSelectByParamsStatementId();
	}

	public boolean callPlugins(Method method, TopLevelClass topLevelClass) {
		return context.getPlugins().providerSelectByParamsWithoutBLOBsMethodGenerated(method, topLevelClass,
				introspectedTable);
	}
}
