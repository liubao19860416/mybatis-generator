 ...
 * @author Jeff Butler
 */
public class AnnotatedUpdateByParamsWithoutBLOBsMethodGenerator extends UpdateByParamsWithoutBLOBsMethodGenerator {

	public AnnotatedUpdateByParamsWithoutBLOBsMethodGenerator() {
		super();
	}
	...
	public void addMapperAnnotations(Interface interfaze, Method method) {
		...
		sb.append(introspectedTable.getUpdateByParamsStatementId());
		sb.append("\")"); //$NON-NLS-1$
