 ...
 * @author Jeff Butler
 */
public class AnnotatedUpdateByParamsSelectiveMethodGenerator extends UpdateByParamsSelectiveMethodGenerator {

	public AnnotatedUpdateByParamsSelectiveMethodGenerator() {
		super();
	}
	...
	public void addMapperAnnotations(Interface interfaze, Method method) {
		...
		sb.append(introspectedTable.getUpdateByParamsSelectiveStatementId());
		sb.append("\")"); //$NON-NLS-1$
