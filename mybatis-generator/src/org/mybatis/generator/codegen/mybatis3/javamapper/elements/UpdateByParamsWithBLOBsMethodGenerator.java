 ...
 * 
 */
public class UpdateByParamsWithBLOBsMethodGenerator extends AbstractJavaMapperMethodGenerator {
	...
	public void addInterfaceElements(Interface interfaze) {
		...
		method.setName(introspectedTable.getUpdateByParamsWithBLOBsStatementId());
		...
		if (context.getPlugins().clientUpdateByParamsWithBLOBsMethodGenerated(method, interfaze, introspectedTable)) {
