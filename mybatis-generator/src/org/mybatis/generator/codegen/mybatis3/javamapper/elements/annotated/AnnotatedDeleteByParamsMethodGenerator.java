 ...
 * @author Jeff Butler
 */
public class AnnotatedDeleteByParamsMethodGenerator extends DeleteByParamsMethodGenerator {

	public AnnotatedDeleteByParamsMethodGenerator() {
		super();
	}
	...
	public void addMapperAnnotations(Interface interfaze, Method method) {
		...
		sb.append(introspectedTable.getDeleteByParamsStatementId());
		sb.append("\")"); //$NON-NLS-1$
