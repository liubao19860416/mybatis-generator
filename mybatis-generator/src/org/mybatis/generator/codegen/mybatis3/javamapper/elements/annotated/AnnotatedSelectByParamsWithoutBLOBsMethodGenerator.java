 ...
 * @author Jeff Butler
 */
public class AnnotatedSelectByParamsWithoutBLOBsMethodGenerator extends SelectByParamsWithoutBLOBsMethodGenerator {

	public AnnotatedSelectByParamsWithoutBLOBsMethodGenerator() {
		super();
	}
	...
	public void addMapperAnnotations(Interface interfaze, Method method) {
		...
		sb.append(introspectedTable.getSelectByParamsStatementId());
		sb.append("\")"); //$NON-NLS-1$
