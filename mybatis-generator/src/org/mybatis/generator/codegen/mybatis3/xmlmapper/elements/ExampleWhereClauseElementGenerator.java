...
public class ExampleWhereClauseElementGenerator extends AbstractXmlElementGenerator {
	...
	private boolean isForUpdateByParams;

	public ExampleWhereClauseElementGenerator(boolean isForUpdateByParams) {
		super();
		this.isForUpdateByParams = isForUpdateByParams;
	}
	...
	public void addElements(XmlElement parentElement) {
		...
		if (isForUpdateByParams) {
			answer.addAttribute(new Attribute("id", introspectedTable.getMyBatis3UpdateByParamsWhereClauseId())); //$NON-NLS-1$
		} else {
