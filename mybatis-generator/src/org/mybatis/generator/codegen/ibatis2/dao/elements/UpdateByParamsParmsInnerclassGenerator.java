 ...
 * 
 */
public class UpdateByParamsParmsInnerclassGenerator extends AbstractDAOElementGenerator {

	public UpdateByParamsParmsInnerclassGenerator() {
		super();
	}
	...
	public void addImplementationElements(TopLevelClass topLevelClass) {
		...
		InnerClass innerClass = new InnerClass(new FullyQualifiedJavaType("UpdateByParamsParms")); //$NON-NLS-1$
