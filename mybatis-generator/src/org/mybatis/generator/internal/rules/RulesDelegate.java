...
public class RulesDelegate implements Rules {
	...
	public boolean generateCountByParams() {
		return rules.generateCountByParams();
	}

	public boolean generateDeleteByParams() {
		return rules.generateDeleteByParams();
	}
	...
	public boolean generateSelectByParamsWithBLOBs() {
		return rules.generateSelectByParamsWithBLOBs();
	}

	public boolean generateSelectByParamsWithoutBLOBs() {
		return rules.generateSelectByParamsWithoutBLOBs();
	}
	...
	public boolean generateMyBatis3UpdateByParamsWhereClause() {
		return rules.generateMyBatis3UpdateByParamsWhereClause();
	}

	public boolean generateUpdateByParamsSelective() {
		return rules.generateUpdateByParamsSelective();
	}

	public boolean generateUpdateByParamsWithBLOBs() {
		return rules.generateUpdateByParamsWithBLOBs();
	}

	public boolean generateUpdateByParamsWithoutBLOBs() {
		return rules.generateUpdateByParamsWithoutBLOBs();
	}
